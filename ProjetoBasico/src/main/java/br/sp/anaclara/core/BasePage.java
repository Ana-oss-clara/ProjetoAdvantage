...
public class BasePage {
	...
	public void clicarCheckByXpath(String xpath) {
	...
	public void selecionarComboTxtByXpath(String xpath, String valor) {
	...
	public void clicarBotaoByXpath(String Xpath) throws InterruptedException {
		clicarBotao(By.id(Xpath));
	}
